				...
				<div class="row">
					<div class="col-lg-4 col-sm-12">
						<a class="brand-logo-top " title="Jonopad News" href="#">
							<img class="img-fluid" src="media/imgAll/icon/dhaka-post-logo.svg" alt="Jonopad-news">
						</a>
					</div>
                        ...
                        <div class="col-md-12">
                            <form id="cse-search-box" action="/keywordsearch" method="get">
                                <div class="search_logo display-flex">
                                    ...
                                    <input name="search" class="search-bar" placeholder="অনুসন্ধান করুন" title="Search"
                                        type="search">
                                    <button onclick="performSearch()"><i id="searchButton" class="fa fa-search"></i></button>
                                    <a onclick="hideSearchBox()" class="close-search"id="closeButton"  href="#"><i
					...
					<nav class="navbar navbar-default navbar-expand-lg">
						...
						<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
									<a href="#" class="nav-link " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-bars"></i> অন্যান্য<span class="caret"></span></a>
									<ul class="dropdown-menu">
										...
										<li class="nav-item"><a class="nav-link" href="#">চাকরি</a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#">স্বাস্থ্য
												সংবাদ</a></li>
										<li class="nav-item"><a class="nav-link" href="#">লাইফস্টাইল</a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#">ধর্ম</a>
										</li>


									</ul>
								</li>
								<li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-search" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</nav>
				</div>
